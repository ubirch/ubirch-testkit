...
The micropython example code uses a SIM Card with SIGNiT applet for cryptographic functionality (e.g. a 1nce SIM with ubirch functionality). For that reason,
